            ...
            <Block>
              ...
              <Fade triggerOnce delay={100}>
                <Item>
                  ...
                  <ItemSub>
                    2015 - 2016 • Rochester Institute of Technology, NY
                  </ItemSub>
                  <ItemText>
              ...
              <Fade triggerOnce delay={200}>
                <Item>
                  ...
                  <ItemSub>
                    2010 - 2014 • Rochester Institute of Technology, NY
                  </ItemSub>
                  <ItemText>
            ...
            <Block>
                ...
                <Item>
                  ...
                  <List>
                    <li>
                      ...
                      graphic and layout communication materials
                    </li>
                    <li>
                      Delegate tasks to 7 team members and provide project
                      guidance
                    </li>
                    <li>
                      Supervise the assessment of materials to ensure design
                      quality
                    </li>
                    <li>
              ...
              <Fade triggerOnce delay={200}>
                <Item>
                  ...
                  <ItemSub>
                    2017 - 2018 • Stepping Stone Advertising, NY
                  </ItemSub>
                  <List>
                    <li>
                      Developed marketing programs including logos, brochures,
                      and ads
                    </li>
                    <li>
